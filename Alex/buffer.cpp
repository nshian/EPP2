...
// Disable interrupts
void enterAtomic(volatile unsigned char* csreg) {
    *csreg = SREG;
    cli();
}

// Re-enable interrupts
void exitAtomic(volatile unsigned char csreg) {
    SREG = csreg;
}
...
void freeBuffer(volatile TBuffer* buffer) {
...
int dataAvailable(volatile TBuffer* buffer) {
