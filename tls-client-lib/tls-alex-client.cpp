...
void connectToServer(const char *serverName, int portNum)
{
	...
	createClient(serverName, portNum,1,CA_CERT_NAME,SERVER_NAME_ON_CERT,1,CLIENT_CERT,CLIENT_KEY,readerThread,writerThread);
